       ...
       <div class="row">
          ...
          <div class="col-sm-6 col-md-4 col-lg-4">
             <div class="box">
                ...
                <div class="img-box">
                   <img src="images/shin_guard1.jpg" alt="">
                </div>
                <div class="detail-box">
                   <h5>
                      shin_guard
       ...
       <div class="row">
          ...
          <div class="col-sm-6 col-md-4 col-lg-4">
             <div class="box">
                ...
                <div class="img-box">
                   <img src="images/bottle1.jpg" alt="">
                </div>
                <div class="detail-box">
                   <h5>
                      bottle
       ...
       <div class="row">
          <div class="col-sm-6 col-md-4 col-lg-4">
             <div class="box">
                ...
                <div class="img-box">
                   <img src="images/bkball.jpeg" alt="">
                </div>
                <div class="detail-box">
                   <h5>
                      Ball
