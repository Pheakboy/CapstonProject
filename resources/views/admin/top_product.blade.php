      ...
      @include('admin.header')
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{url('/add_top_product')}}" method="POST" enctype="multipart/form-data">

                    @csrf

                <div class="div_center">
                    <h1 class="font_size">ADD TOP PRODUCTS</h1>
                    ...
                    <div class="div_design">
                        <input type="submit" value="Add Top Product" class="btn btn-primary" >
                    </div>
