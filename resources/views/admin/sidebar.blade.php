<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="sidebar-brand brand-logo" href="index.html"><img src="admin/assets/images/GSport.png" alt="logo" /></a>
      <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="admin/assets/images/GSport.png" alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        <div class="profile-desc">
          <div class="profile-pic">
            ...
            <div class="profile-name">
              <h5 class="mb-0 font-weight-normal">Admin Capton</h5>
              <span>Capton Project</span>
            </div>
          </div>
