<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="sidebar-brand brand-logo" href="redirect"><img src="admin/assets/images/GSport.png" alt="logo" /></a>
      <a class="sidebar-brand brand-logo-mini" href="redirect"><img src="admin/assets/images/GSport.png" alt="logo" /></a>
    </div>
    <ul class="nav">
